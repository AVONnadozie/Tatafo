...
public class FeedContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.yellowbambara.tatafo";
    ...
    public static Uri buildUriForSourceUri(String sUri){
        return CONTENT_URI.buildUpon().appendPath(COLUMN_URI).appendQueryParameter(COLUMN_URI,sUri).build();
    }

    public static Uri buildUriForSourceName(String sUri){
        return CONTENT_URI.buildUpon().appendPath(COLUMN_NAME)
                .appendQueryParameter(COLUMN_NAME, sUri).build();
    }

    public static Uri buildUriForIsDefault(boolean isDefault){
        return CONTENT_URI.buildUpon().appendPath(COLUMN_DEFAULT)
                .appendQueryParameter(COLUMN_DEFAULT, isDefault ? "1" : "0").build();
    }
